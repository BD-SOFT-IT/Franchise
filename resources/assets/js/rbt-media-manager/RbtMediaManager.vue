<template>
    <div class="rmm-container">
        <div class="rbt-media-manager" :class="{'modal fade': showAsModal}" :role="showAsModal ? 'dialog' : ''" :tabindex="showAsModal ? '-1' : ''"
             :id="rmmModalID" :aria-labelledby="showAsModal ? 'rmmModalLabel' : ''" :aria-hidden="showAsModal ? 'true' : 'false'">
                            ...
                            <div class="rmm-top-nav">
                                ...
                                <div class="btn-group reload" role="group">
                                    <a href="#" class="btn btn-light" title="Reload" @click.prevent="reload">
                                        <i class="fa fa-refresh" :class="{'fa-pulse': reloading}"></i> <span class="d-none d-lg-inline">{{ reloadButton }}</span>
                                    </a>
                                </div>
...
<script>
    ...
    export default {
        props: ['directory', 'user_id', 'url_prefix', 'show_as', 'element_id', 'modalId'],
        components: {
        ...
        methods: {
            ...
            getFiles() {
                this.displayFiles = [];
                let url = '';
                if(this.directories.selectedDirectory === '/' && this.directories.selectedDirectory !== undefined) {
        ...
        computed: {
            ...
            rmmModalID() {
                return (typeof this.modalId !== 'undefined' && this.modalId !== null) ? this.modalId : 'rbtMediaManager';
            }
        }
    }
</script>
