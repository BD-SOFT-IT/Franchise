...
@section('sub-title', 'Pending Orders')
@section('page-description', 'View all pending orders.')

@section('orders-active', 'active')
@section('orders-pending-active', 'active')
...
@section('admin-content')
    <div class="admin-orders">
        ...
        <div class="admin-orders-table">
            ...
            <order-data-table api_url="{{ route('admin.api.orders', ['type' => 'pending']) }}" order_type="Pending"></order-data-table>
