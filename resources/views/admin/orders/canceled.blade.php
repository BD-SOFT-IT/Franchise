...
@section('sub-title', 'Canceled Orders')
@section('page-description', 'View all canceled orders.')

@section('orders-active', 'active')
@section('orders-canceled-active', 'active')
...
@section('admin-content')
    <div class="admin-orders">
        ...
        <div class="admin-orders-table">
            ...
            <order-data-table api_url="{{ route('admin.api.orders', ['type' => 'canceled']) }}" order_type="Canceled"></order-data-table>
