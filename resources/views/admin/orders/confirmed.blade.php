...
@section('sub-title', 'Confirmed Orders')
@section('page-description', 'View all confirmed orders.')

@section('orders-active', 'active')
@section('orders-confirmed-active', 'active')
...
@section('admin-content')
    <div class="admin-orders">
        ...
        <div class="admin-orders-table">
            ...
            <order-data-table api_url="{{ route('admin.api.orders', ['type' => 'confirmed']) }}" order_type="Confirmed"></order-data-table>
