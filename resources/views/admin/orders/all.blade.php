...
@section('page-description', 'View All Orders')

@section('orders-active', 'active')
@section('orders-all-active', 'active')
...
@section('admin-content')
    <div class="admin-orders">
        ...
        <div class="admin-orders-table">
            ...
            <order-data-table api_url="{{ route('admin.api.orders', ['type' => 'all']) }}" order_type="All"></order-data-table>
