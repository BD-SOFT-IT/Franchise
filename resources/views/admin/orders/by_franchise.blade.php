...
@section('sub-title', 'Orders By Franchise')
@section('page-description', 'View all Orders By Franchise.')

@section('orders-active', 'active')
@section('orders-by-franchise-active', 'active')
...
@section('admin-content')
    <div class="admin-orders">
        ...
        <div class="admin-orders-table">
            ...
            <order-data-table
                    api_url="{{ route('admin.api.orders', ['type' => 'by-franchise']) }}"
                    order_type="By Franchise">
            </order-data-table>
