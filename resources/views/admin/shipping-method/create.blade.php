...
@section('sub-title', 'Create Delivery Method')
@section('page-description', 'Create Delivery Method')
...
@section('admin-content')
    <div class="all-admins-container">
        ...
        <div class="card new-admin">
            ...
            <div class="card-body">
                <form action="{{ route('admin.shipping.add') }}" method="post">
                    @csrf
                    <div class="form-group row">
                        <label for="method_name" class="col-md-3 col-form-label">Method Name</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control {{ $errors->has('method_name') ? 'is-invalid' : '' }}" value="{{ old('method_name') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('method_charge') ? 'is-invalid' : '' }}" value="{{ old('method_charge') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control {{ $errors->has('method_time') ? 'is-invalid' : '' }}" value="{{ old('method_time') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control {{ $errors->has('method_note') ? 'is-invalid' : '' }}" name="method_note" id="method_note" rows="4" style="resize: none;">{!! old('method_note')  !!}</textarea>
