            ...
            <div class="header-logo">
                <a href="{{ route('index') }}" target="_blank">
                    @if($img && strlen($img) > 10)
                        <img src="{{ imageToDataUrl(storage_path('uploads/' . $img)) }}" alt="{{ $title }}">
                    @else
                        <img src="{{ imageToDataUrl($_SERVER["DOCUMENT_ROOT"] . '/images/logos/bd_soft_it.png') }}" alt="{{ $title }}">
                    @endif
    ...
    <tr>
        <td>
            <div style="width: 100%;text-align: center;">
                <h2 style="letter-spacing: 0.02em;font-size: 40px; margin: 0 0 5px;">Hello {{ $name }},</h2>
                <p style="margin: 0 0 15px; color: #000; font-size: 22px; letter-spacing: 0.06em;">Sorry to hear that you lost your password!</p>
            </div>
            ...
            <div class="inner-section" style=" padding: 20px 0 0;display: -ms-flexbox;display: -webkit-box;display: flex;-ms-flex-wrap: wrap;flex-wrap: wrap; width: 100%; text-align: center;background-color: #d6d6d6;">
                <div style="width: 40%;-ms-flex: 0 0 40%;-webkit-box-flex: 0;flex: 0 0 40%;" class="inner-img">
                    <img src="{{ imageToDataUrl($_SERVER["DOCUMENT_ROOT"] . '/images/mailbg-1.png') }}" alt="">
                </div>
                ...
                <div class="message" style="width: 60%;-ms-flex: 0 0 60%;-webkit-box-flex: 0;flex: 0 0 60%;">
                    ...
                    <div style="padding: 0 25px;">
                        <div class="msg-header-text">
                            <h2 style="text-align: center;">Please Verify your email to reset your password.</h2>
                        </div>
    ...
    <tr>
        <td>
            <div class="">
                <p class="not-u">
                    <span>
                        If The above link is not working copy this link & paste it in Browser: <a href="{{ $url }}">{{ $url }}</a>
                    </span>
                    <br>
                    <br>
                    <br>
                    ...
                    account with <a href="mailto:{{ $email }}">{{ $email }}</a>.
                    <br>
