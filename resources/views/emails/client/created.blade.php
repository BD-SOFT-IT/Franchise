        ...
        <td>
            <div class="header-logo">
                <a href="{{ url('/') }}" target="_blank">
                    ...
                    @else
                        <img src="{{ asset('images/logos/bd_soft_it.png') }}" alt="{{ $title }}" data-auto-embed="attachment"/>
                    @endif
    ...
    <tr>
        <td>
            <div style="width: 100%;text-align: center;">
                ...
                <p style="margin: 0 0 15px; color: #000; font-size: 22px; letter-spacing: 0.06em;">Thank you for joining with us.</p>
            </div>
                    ...
                    <div style="padding: 0 25px;">
                        <div class="msg-header-text">
                            <h2 style="text-align: center;">
                                @if(isset($url))
                                    Verify your email & Start shopping from wide range list of Products.
                                @elseif(isset($password))
                                    Login & Start shopping from wide range list of Products.
                                @endif
                            </h2>
                        </div>
                        ...
                        <div class="information" style="text-align: center;">
                            ...
                            @elseif(isset($password))
                                Email: <span class="verify-link">{{ $email }}</span>
                                <br> <br> <br> <br>
                                Password: <span class="verify-link">{{ $password }}</span>
                            @endif
                        </div>
                    </div>
        ...
        <td>
            <div class="">
                <p class="not-u">
                    @if(isset($url))
                        <span>
                            If The above link is not working copy this link & paste it in Browser:
                            <br>
                            <a href="{{ $url }}">{{ $url }}</a>
                        </span>
                    @endif
                    ...
                    You are receiving this email because someone wanted to create an account
                    <a href="{{ route('index') }}" target="_blank"><strong>{{ $title }}</strong></a>
                    with <a href="mailto:{{ $email }}">{{ $email }}</a>.
                    <br>
                    If this is not you then just ignore this E-mail.
                </p>
